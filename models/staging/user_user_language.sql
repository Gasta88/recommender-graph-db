...
FROM
    {{ source('recommender_graph_db_dev', 'c2_dev_core_setting_user') }}
{% else %}
SELECT
    NULL AS user_id, NULL AS path_name, NULL AS user_language, NULL AS customer_name
WHERE
...
FROM
    {{ source('recommender_graph_db_dev', 'c3_dev_core_setting_user') }}
{% else %}
SELECT
    NULL AS user_id, NULL AS path_name, NULL AS user_language, NULL AS customer_name
WHERE
